...
# train_image_array_gen <- flow_images_from_data(x_train, y_train)
...
#############################
# validation images
valid_image_array_gen <- flow_images_from_directory(dir.val, 
                                                    val_data_gen,
...
val_prediction = predict_generator(model, valid_image_array_gen,
                  steps = as.integer(valid_samples / batch_size))

# install.packages('pROC')
library(pROC)
# auc(valid_image_array_gen$labels, as.vector(val_prediction))
roc(valid_image_array_gen$labels, as.vector(val_prediction), plot=T)
